...
class Kasturi_Packages_Widget extends \Elementor\Widget_Base {
  ...
  protected function render() {
            ...
            if (typeof Swiper !== 'undefined') {
                new Swiper('#<?php echo esc_js($widget_id); ?> .swiper-container', {
                    ...
                    breakpoints: {
                        320: { slidesPerView: 1 },
                        768: { slidesPerView: 2 },
                        1024: { slidesPerView: <?php echo (int)$slides_to_show; ?> }
                    }
                });
            }
        });
    ...
    <style>
        ...
        .package-cta {
            display: flex;
            justify-content: var(--cta-alignment, flex-start); /* Default left */
        }
        ...
        .travel-packages-widget.is-slider .swiper-slide {
            display: flex;
            justify-content: center;
        }

        .travel-packages-widget.is-slider .package-card {
            width: 340px;
            margin: 0 16px;
        }
